<?php include '../inc/header.inc.php'; ?>
    ...
    <p id="slogan">Imaluu vous propose de creer le voyage de vos reves en fonction de votre budget, vos préférences, vos dates...
        ...
        <div class="card-area">
            <div class="flip-card">
                ...
                <div class="flip-card-back">
                    <h2 style="position: absolute;">John Doe</h2>
                    <p>Moi manger nems moi etre racaille racaille de shangai moi etre frere de Bruce lee. Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores incidunt ea ipsa adipisci esse cum excepturi illum culpa, veniam illo numquam corporis, rerum fugiat, velit fugit accusamus itaque obcaecati pariatur.</p> 
                    <img src="../assets/img/img5.jpg" alt="Avatar">
                    <button>En savoir plus</button>
                </div>
                </div>
